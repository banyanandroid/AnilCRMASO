...
import banyan.com.anilcrmaso.adapter.MyListAdapter;
import banyan.com.anilcrmaso.adapter.MyListPrimaryAdapter;
import banyan.com.anilcrmaso.database.DBManager;
import banyan.com.anilcrmaso.database.DatabaseHelper;
import banyan.com.anilcrmaso.global.SessionManager;
import banyan.com.anilcrmaso.model.Hero;
...
public class Activity_Primary_Order_Form extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Primary Order Form");
...
//                str_price = Arraylist_product_price.get(position);
        ...
        btn_add_to_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (str_Shop_id == null) {
                    ...
                    MyListAdapter adapter = new MyListAdapter(Activity_Primary_Order_Form.this, R.layout.my_custom_list, heroList);
                    ...
                    if (heroList.size() > 0){
                        ...
                        if (ismatch == false) {
                            ...
                            heroList.add(new Hero(str_product_id, str_group_id, str_amt, str_product, str_qty));
                            adapter = new MyListPrimaryAdapter(Activity_Primary_Order_Form.this, R.layout.my_custom_list, heroList);
                            list_cart.setAdapter(adapter);
                            Fun_Total_Cal();
    ...
    public void Function_Get_SHOP() {
        ...
        System.out.println("### AppConfig.url_user_shop_list " + AppConfig.url_primary_order);
        final StringRequest request = new StringRequest(Request.Method.POST,
                AppConfig.url_primary_order, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; arr.length() > i; i++) {
                            ...
                            long response_product = dbManager.insert_PRODUCT(id,name,group_id,retail_price,dis_price);
            ...
            if (str_final_order.equals("")) {
                ...
                try {
                    ...
                    if (isNetworkConnected()) {
                        ...
                        dbManager.open();
                        long response = dbManager.insert_Order_Form(str_Shop_id, str_final_order, str_user_id, str_offer);
