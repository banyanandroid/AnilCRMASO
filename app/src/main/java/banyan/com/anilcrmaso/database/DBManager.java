...
public class DBManager {
     ...
     *  ORDER FORM
     * ****************************/
    public long insert_Order_Form(String shop_id, String final_order, String user_id, String str_combo_offer) {
    ...
    public Cursor Fetch_Order_Form() {
        ...
        String[] columns = new String[]{DatabaseHelper.ORDER_FORM_ID, DatabaseHelper.ORDER_FORM_SHOP_ID, DatabaseHelper.ORDER_FORM_FINAL_ORDER, DatabaseHelper.ORDER_FORM_USER_ID, DatabaseHelper.ORDER_FORM_COMBO_OFFER};
     ...
     *  product
     * ************************/
    public long insert_PRODUCT(String product_id, String product_name, String productgroup_id, String retail_price, String distributor_price) {
    ...
    public Cursor Fetch_product(String str_group_id) {
        ...
        String[] columns = new String[]{DatabaseHelper.PRODUCT_ID, DatabaseHelper.PRODUCT_NAME, DatabaseHelper.PRODUCT_GROUP_ID
                , DatabaseHelper.PRODUCT_RETAIL_PRICE, DatabaseHelper.PRODUCT_DIS_PRICE};
